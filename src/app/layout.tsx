...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
        {
          url: `${process.env.NEXT_PUBLIC_FRONTEND_URL || "https://frontend.144.225.147.46.nip.io"}/banner.webp`,
          width: 1200,
          height: 630,
  ...
  twitter: {
    ...
    title: "Star Recs | Recomendaciones de Películas con IA",
    description: "...",
    images: [`${process.env.NEXT_PUBLIC_FRONTEND_URL || "https://frontend.144.225.147.46.nip.io"}/banner.webp`],
  },
  robots: {
    index: true,
    follow: true,
